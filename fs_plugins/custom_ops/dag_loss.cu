...
{
    int bucket_idx = blockIdx.x % BLOCK_BUCKET;
    ...
    int prelen, int tarlen, int translen)
{
    ...
    int pre_block_idx = blockIdx.x / n_trans;
    int trans_block_idx = blockIdx.x % n_trans;
