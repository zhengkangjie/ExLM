...
class ESM2RobertaModel(FairseqEncoderModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if aa_mask is None:
            pos_dim1 = new_arange(src_tokens)
            pos_dim2 = torch.zeros_like(pos_dim1)
            aa_mask = (pos_dim1, pos_dim2)

        x, extra = self.encoder(src_tokens, features_only, return_all_hiddens, token_dropout=self.token_dropout, need_head_weights=need_head_weights, return_contacts=return_contacts, aa_mask=aa_mask, **kwargs)
    ...
    def forward(
        ...
        **unused,
        ...
        x, extra = self.extract_features(
            src_tokens, aa_mask=aa_mask, return_all_hiddens=return_all_hiddens, token_dropout=token_dropout,
